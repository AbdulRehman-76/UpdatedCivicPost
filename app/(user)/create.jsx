...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, TextInput, Alert, Image, Platform, Modal } from 'react-native';
...
export default function CreateReportScreen() {
  ...
  const handleSubmit = () => {
    ...
    if (!originalLocation) {
      Alert.alert('Location Required', 'Please provide the incident location');
      return;
    }
      ...
      <ScrollView style={styles.formScroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.categoryHeader}>
            <View style={styles.catInfo}>
              ...
              <View>
                ...
                <Text style={styles.catSubtext}>Provide details below</Text>
              </View>
            </View>
        ...
        <View style={styles.card}>
          <View style={styles.labelRow}>
            <Ionicons name="location" size={20} color="#ef4444" style={styles.labelIcon} />
          ...
          <View style={[styles.inputRow, { height: locationHeight, alignItems: 'flex-start' }]}>
            <Ionicons
            ...
            />
            <TextInput
              style={[styles.textInputFlex, { height: '100%', fontSize: 14 }]}
              value={location}
              onChangeText={(text) => {
                setLocation(text);
                if (originalLocation) {
              ...
              onContentSizeChange={(e) => {
                ...
                const height = Math.max(70, Math.min(120, e.nativeEvent.contentSize.height + 20));
          ...
          <TouchableOpacity style={styles.currentLocBtn} onPress={getCurrentLocation}>
            {isLocating ? (
              <View style={styles.locationBtnContent}>
                ...
                <Text style={styles.currentLocText}>Locating...</Text>
              </View>
            ) : (
              <View style={styles.locationBtnContent}>
        ...
        <View style={styles.card}>
          <View style={styles.labelRow}>
            <Ionicons name="document-text" size={20} color="#ef4444" style={styles.labelIcon} />
            <Text style={styles.cardLabel}>INCIDENT DESCRIPTION</Text>
            <Text style={styles.required}>*</Text>
          </View>
          <Text style={styles.fieldDescription}>
        ...
        <View style={styles.card}>
          <View style={styles.evidenceHeader}>
            <View style={styles.labelRow}>
              <Ionicons name="camera" size={20} color="#6366f1" style={styles.labelIcon} />
            ...
            <Text style={styles.evidenceSubtitle}>
              Photos and videos help verify your report and speed up resolution
            </Text>
          </View>
        ...
        <View style={styles.card}>
          <View style={styles.labelRow}>
            <Ionicons name="flag" size={20} color="#6366f1" style={styles.labelIcon} />
          ...
          <View style={styles.priorityRow}>
            {[
              { key: 'Low', icon: 'remove-circle', color: '#10b981', bg: '#d1fae5' },
        ...
        <View style={styles.card}>
          <View style={styles.labelRow}>
            <Ionicons name="call" size={20} color="#6366f1" style={styles.labelIcon} />
            <Text style={styles.cardLabel}>CONTACT INFORMATION</Text>
            <Text style={styles.optionalText}>(Optional)</Text>
          </View>
          <Text style={styles.fieldDescription}>
            You may provide an alternative contact number if someone else can be reached regarding this report. 
          </Text>
          ...
          <View style={styles.privacyNote}>
            ...
            <Text style={styles.privacyText}>Your information will be kept confidential</Text>
          </View>
        </View>

        {/* 7. Submit Button */}
        <TouchableOpacity style={styles.submitBtn} onPress={handleSubmit}>
          <Ionicons name="paper-plane" size={22} color="#fff" style={{marginRight: 10}} />
        ...
        >
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <Text style={styles.modalTitle}>Evidence Guidelines</Text>
              <TouchableOpacity onPress={() => setShowEvidenceHelp(false)}>
            ...
            <View style={styles.modalBody}>
              <View style={styles.guidelineItem}>
                ...
                <Text style={styles.guidelineText}>Up to 5 images allowed</Text>
              </View>
              
              <View style={styles.guidelineItem}>
                <Ionicons name="videocam" size={20} color="#3b82f6" />
                <Text style={styles.guidelineText}>Or 1 video file</Text>
              </View>
              
              <View style={styles.guidelineItem}>
                <Ionicons name="document" size={20} color="#3b82f6" />
                <Text style={styles.guidelineText}>Maximum 100MB per file</Text>
              </View>
              
              <View style={styles.guidelineDivider} />
              
              <Text style={styles.guidelineTip}>
                <Text style={styles.guidelineTipBold}>Tip: </Text>
                Clear photos showing the full context of the incident help authorities respond faster and more effectively.
              </Text>
            </View>
          </View>
        </TouchableOpacity>
