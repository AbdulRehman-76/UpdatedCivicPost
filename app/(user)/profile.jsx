    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.profileCard}>
          ...
          {/* User Info */}
          <Text style={styles.profileName}>{currentUser?.name || 'Citizen'}</Text>
          <View style={styles.userTypeChip}>
            <Ionicons name="person" size={14} color="#3b82f6" />
            <Text style={styles.userTypeText}>Regular Citizen</Text>
          </View>
          ...
          <View style={styles.card}>
            <View style={styles.contactItem}>
              ...
              <View style={styles.contactInfo}>
                ...
                <Text style={styles.contactValue}>{currentUser?.email || 'N/A'}</Text>
              </View>
            </View>
            ...
            <View style={styles.contactItem}>
              ...
              <View style={styles.contactInfo}>
                ...
                <Text style={styles.contactValue}>{currentUser?.phone || 'Not provided'}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        {/* Activity Summary */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Activity & Contribution</Text>
        ...
        <View style={styles.section}>
          ...
          >
            <View style={styles.viewReportsLeft}>
              <View style={styles.viewReportsIconBox}>
                <Ionicons name="folder-open" size={22} color="#3b82f6" />
              </View>
              <View>
                <Text style={styles.viewReportsTitle}>View My Reports</Text>
