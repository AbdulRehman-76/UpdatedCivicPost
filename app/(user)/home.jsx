...
export default function HomeScreen() {
  ...
  // Converts first letter to uppercase: 'pending' → 'Pending'
  // statusColors keys are title-case but Firestore stores lowercase
  ...
  const renderRecentReport = ({ item }) => {
    // ← FIXED: capitalize item.status before looking up statusColors
    //    Firestore saves 'pending', but statusColors has key 'Pending'
    const capitalizedStatus = capitalize(item.status);
    const statusStyle = statusColors[capitalizedStatus] || statusColors.Pending;
